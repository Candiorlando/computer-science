...
export const metadata: Metadata = {
  ...
  description: "How Pathways Pro collects, uses, and protects your information.",
};
...
export default function Page() {
  return (
    <div className="max-w-3xl space-y-5 py-8">
      ...
      <p className="text-lg text-ink/70">How Pathways Pro collects, uses, and protects your information.</p>
