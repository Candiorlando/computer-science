...
export const metadata: Metadata = {
  ...
  description: "See Pathways Pro in action — request a personalized demo.",
};
...
export default function Page() {
  return (
    <div className="max-w-3xl space-y-5 py-8">
      ...
      <h1 className="text-4xl tracking-tight">Request a Demo</h1>
      <p className="text-lg text-ink/70">See Pathways Pro in action — request a personalized demo.</p>
