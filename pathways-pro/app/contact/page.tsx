...
export const metadata: Metadata = {
  ...
  description: "Get in touch with the Pathways Pro team.",
};
...
export default function Page() {
  return (
    <div className="max-w-3xl space-y-5 py-8">
      ...
      <h1 className="text-4xl tracking-tight">Let’s Connect</h1>
      <p className="text-lg text-ink/70">Get in touch with the Pathways Pro team.</p>
