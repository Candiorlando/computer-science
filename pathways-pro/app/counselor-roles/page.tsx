...
// Public page: the top 30 vocational rehabilitation counseling roles
// that use Pathways Pro — curated ranking across three market tiers,
// with alternate views sorted by salary and grouped by required
// certification, plus a complete Services & Markets profile for the
// Forensic Vocational Expert title.
  ...
  return (
    <div className="space-y-10">
      ...
      <section
        ...
        className="border-2 border-cyan-300 rounded-xl p-6 bg-cyan-50/30"
      >
        <p className="text-[10px] uppercase tracking-widest text-cyan-700 font-semibold mb-1">
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-6">
          <div>
            <h3 className="text-sm uppercase tracking-wider font-semibold text-cyan-800 mb-2">
              Core services
            </h3>
            <ul role="list" className="space-y-2 text-sm">
              {[
                ...
                <li key={t} className="flex gap-2">
                  <span aria-hidden className="text-cyan-700 shrink-0 mt-0.5">✓</span>
                  <span>
                    <strong>{t}:</strong>{" "}
          ...
          <div className="space-y-5">
            <div>
              ...
              <p className="text-sm text-ink/80 bg-white border border-cyan-200 rounded-md p-3">
    ...
    <li className="saas-card h-full">
      ...
      <div className="flex flex-wrap gap-1.5 mt-2.5">
        {role.certs.map((c) => (
          <span
            key={c}
            className="text-[9px] uppercase tracking-wider bg-cyan-100 text-cyan-900 px-1.5 py-0.5 rounded-full font-semibold"
          >
            {c}
          </span>
        ))}
