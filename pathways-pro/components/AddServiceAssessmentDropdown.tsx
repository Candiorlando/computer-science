        ...
        >
          <div className="sticky top-0 bg-white border-b border-ink/10 p-2">
            <input
              ...
              aria-label="Search"
              className="w-full text-sm bg-cream/40 border border-ink/15 rounded px-3 py-1.5 focus:outline-none focus:border-cyan-500"
            />
            {q && (
  ...
  return (
    <li role="none">
      <button
        ...
        role="menuitem"
        onClick={onClick}
        className="w-full text-left px-3 py-2 hover:bg-cyan-50 focus:outline-none focus:bg-cyan-50"
      >
